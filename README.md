...
![A PNG file that shows an example of this project](https://github.com/azuresphere7/Web-Neo4j-Visualization/blob/master/src/images/example.png "Example")
...
![A PNG file that shows the creation of the database in Neo4j Desktop](https://github.com/azuresphere7/Web-Neo4j-Visualization/blob/master/src/images/create-sandbox.png "Neo4j Desktop")

### 2 - Install project dependencies

```sh
git clone git@github.com:azuresphere7/Web-Neo4j-Visualization.git
...
Then open the [App component](https://github.com/azuresphere7/Web-Neo4j-Visualization/blob/master/src/components/App.js) and replace `YOUR-BOLT-URI-HERE` and `YOUR-NEO4J-PASSWORD-HERE` with your Neo4j connection details.
